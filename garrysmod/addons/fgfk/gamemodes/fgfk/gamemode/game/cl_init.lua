...
GM.AZ.ScoreboardName = "Family Guy Fatkid"
GM.Human.HintText = "You're a skinny kid! Your goal is to survive the round. Break down barricades to get better weapons, and run from the Family Guy!"
GM.Zombie.HintText = "You're a skeleton! You're fast but die easily. Use your speed to run down and kill the skinny kids!"
GM.AZ.HintText = "You're the Family Guy! Your goal is to eat all the skinny kids. Left click to eat a player, and right click to stun nearby skinny kids!"
