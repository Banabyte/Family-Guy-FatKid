...
GM.ZombieWinMessage = "Peter Griffin wins!"
GM.NewZombieMessage = "is the Family Guy!"
GM.NewZombiesMessage = "is the new Family Guy!"
GM.AZAbandonMessage = "The Family Guy has abandoned the game!"
...
GM.Human.PlayerModels = {"models/hellinspector/familyguybttm/adamwest_pm.mdl", "models/hellinspector/cleveland/cleveland_player.mdl","models/player/familyguy/chris/chrisg_pm.mdl","models/hellinspector/familyguywandg/tottington_lois_pm.mdl","models/hellinspector/familyguywandg/wallace_peter_pm.mdl","models/hellinspector/familyguywandg/tottington_lois_pm.mdl","models/hellinspector/familyguywandg/hutch_stewie_pm.mdl","models/hellinspector/familyguywandg/gromit_brian_pm.mdl","models/hellinspector/familyguybttm/stewie_pm.mdl","models/hellinspector/bigstewie/bigstewie_pm.mdl","models/hellinspector/lois_family_guy/lois_pm.mdl","models/hellinspector/fgjoepinball/joe_pm.mdl","models/hellinspector/familyguybacktothemultiverse/quagmire_pm.mdl"}
...
GM.Zombie.PlayerModels = {"models/hellinspector/hookerpeter/hookerpeter_pm.mdl","models/hellinspector/familyguywandg/wallace_peter_pm.mdl"}
...
GM.AZ.PlayerModels = {"models/hellinspector/familyguy_bttm/peter_pm.mdl"}
